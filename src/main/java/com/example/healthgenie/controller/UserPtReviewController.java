...
public class UserPtReviewController {
    ...
    @PostMapping("/review")// http://localhost:1234/api/v1/pt/review
...
//        reviewService.addPtReview(dto,1L);
    ...
    @GetMapping("/review/list/trainer") // http://localhost:1234/api/v1/pt/review/list/trainer
    ...
    @GetMapping("/review/list/my") // http://localhost:1234/api/v1/pt/review/list/my
    ...
    @GetMapping("/review/detail") // http://localhost:1234/api/v1/pt/review/detail
