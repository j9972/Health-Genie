...
public class SecurityUtils {
    ...
    public String createAccessToken(String email, AuthProvider provider, String accessToken) {
    ...
    public String createRefreshToken(String email, AuthProvider provider, String refreshToken) {
        HashMap<String, Object> claim = new HashMap<>();
        claim.put("email", email);
        claim.put("provider", provider);
